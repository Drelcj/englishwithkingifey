...
const TestimonialSection = () => {
  return (
    <div className="bg-black p-10 flex flex-col items-center justify-center gap-10 pt-40 pb-40">
      <div className="flex space-x-10 flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6">
        <div className="card w-96 bg-base-100 shadow-xl md:w-1/2">  
          <div className="avatar justify-center py-10">
            <div className="w-24 rounded-full ring ring-blue-500 ring-offset-2">
              ...
              width={384} // The *actual* width in pixels (from inspect element)
              height={384} // Same for height if it's a square avatar
               />
            </div>
          </div>
        ...
        <div className="card w-96 bg-base-100 shadow-xl md:w-1/2">  {/* Adjust width as needed */}
          <div className="avatar justify-center py-10">
            <div className="w-24 rounded-full ring ring-blue-500 ring-offset-2">
              <Image src="https://res.cloudinary.com/dt3czltxx/image/upload/v1709564009/drel_mid_pov.jpg_export_syl5rv.jpg" alt="User Avatar" width={384} // The *actual* width in pixels (from inspect element)
    height={384} // Same for height if it's a square avatar
    />
            </div>
          </div>
