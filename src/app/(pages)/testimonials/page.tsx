...
const TestimonialsPage = () => {
   const testimonials = [
    { 
      ...
      image: "https://res.cloudinary.com/dt3czltxx/image/upload/v1727710780/Passport_gsio0m.jpg" 
    },
    // ... other testimonials
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="bg-white rounded shadow p-4 flex flex-col items-center text-center">
            <Image className="rounded-full mb-4" src={testimonial.image} alt={testimonial.name} />
